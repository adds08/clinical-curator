...
class FhirConstants {
  ...
  // PractitionerRole code system
  static const String practitionerRoleSystem =
      'http://terminology.hl7.org/CodeSystem/practitioner-role';

  // Provenance activity codes (FHIR v3-DataOperation)
  static const String provenanceActivitySystem =
      'http://terminology.hl7.org/CodeSystem/v3-DataOperation';
  static const String provenanceActivityAttest = 'AU';
  static const String provenanceActivitySign = 'SIGN';

  // Composition LOINC types
  static const String compositionTypeProgressNote = '11506-3';
  static const String compositionAttesterModePersonal = 'personal';
  static const String compositionStatusFinal = 'final';
